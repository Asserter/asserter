...
#ifndef _ASSERTION_EQ_H
#define _ASSERTION_EQ_H
...
extern assertop assert_dbl_eq(asserter *, double, double, double, double);
...
extern assertop assert_dbl_skip_eq(asserter *, double, double, double, double);
